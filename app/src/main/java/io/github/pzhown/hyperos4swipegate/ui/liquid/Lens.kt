...
// Mirrored from compose-miuix-ui example and KernelSU manager.
package io.github.pzhown.hyperos4swipegate.ui.liquid
...
fun BackdropEffectScope.lens(
    ...
    val shaderString = if (dispersionEnabled) ROUNDED_RECT_REFRACTION_WITH_DISPERSION_SHADER else ROUNDED_RECT_REFRACTION_SHADER
    ...
    runtimeShaderEffect(key = key, shaderString = shaderString, uniformShaderName = "content") {
