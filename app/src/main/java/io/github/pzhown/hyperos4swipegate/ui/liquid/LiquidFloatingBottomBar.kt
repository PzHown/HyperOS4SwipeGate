...
// Ported from KernelSU manager FloatingBottomBar with package-only integration changes.
...
@Composable
fun RowScope.LiquidFloatingBottomBarItem(
    onClick: () -> Unit,
